...
@Entity
@Data
@Table(name="game_armors")
public class GameArmors implements Serializable {
    ...
    @ApiModelProperty(value = "备用图形代码")
    private String alternategfx;

    @Column(name = "`open_beta_gfx`")
    @ApiModelProperty(value = "公测图形代码")
    private String openBetaGfx;

    @Column(name = "`normcode`")
    @ApiModelProperty(value = "普通模式代码")
    private String normcode;

    @Column(name = "`ubercode`")
    @ApiModelProperty(value = "超级模式代码")
    private String ubercode;

    @Column(name = "`ultracode`")
    @ApiModelProperty(value = "终极模式代码")
    ...
    @ApiModelProperty(value = "背包宽度")
    private Integer invwidth;

    @Column(name = "`invheight`")
    @ApiModelProperty(value = "背包高度")
    ...
    @ApiModelProperty(value = "可投掷")
    private Integer throwable;

    @Column(name = "`stackable`")
    @ApiModelProperty(value = "可叠加")
    private Integer stackable;

    @Column(name = "`minstack`")
    @ApiModelProperty(value = "最小叠加数")
    private Integer minstack;

    @Column(name = "`maxstack`")
    @ApiModelProperty(value = "最大叠加数")
    ...
    public void copy(GameArmors source){
